...
import { ProductPurchasePanel } from '@components/frontStore/catalog/ProductPurchasePanel.js';
import React from 'react';

export default function ProductView({ product }: ProductData) {
  return (
    <ProductProvider product={product}>
      <div className="product__detail baghel-product-page">
        <Area id="productPageTop" className="product__page__top" />
        <div className="product__page__middle page-width">
          <div className="baghel-product-hero grid grid-cols-1 gap-7 md:grid-cols-2">
            <Area
            ...
            <Area
              ...
              coreComponents={[
                ...
                {
                  component: { default: <ProductPurchasePanel /> },
                  sortOrder: 40,
                  id: 'purchasePanel'
                }
              ]}

...
export default function DashboardLayout() {
  return (
    <div className="baghel-admin-dashboard">
      <Area id="dashboardOverview" noOuter />
      <div className="baghel-admin-dashboard__content grid grid-cols-3 gap-5 grid-flow-row">

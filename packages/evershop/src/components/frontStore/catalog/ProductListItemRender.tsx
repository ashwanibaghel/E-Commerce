...
export const ProductListItemRender = ({
  ...
  return (
    <div className="product__list__item__inner baghel-product-card group overflow-hidden">
      <a href={product.url} className="product__list__link block">
        <div className="product__list__image baghel-product-card__image overflow-hidden flex w-full justify-center">
          {product.image && (
            <Image
              src={product.image.url}
              alt={product.image.alt || product.name}
        ...
        <div className="product__list__info baghel-product-card__info mt-3">
